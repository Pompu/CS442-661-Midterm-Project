    ...
    <div class="w-full inline-flex">
        <div class="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto h-52 lg:w-1/2">
            <div class="mb-5">
                ...
                <label for="name" id="nameLabel" class="hidden block mb-2 text-gray-700"></label>
            </div>
            <button id="toggleButton" type="button" 
                    class="shadow-lg bg-teal-500 hover:bg-teal-400 appearance-none border rounded w-full p-3 text-gray-700 text-sm font-bold leading-tight cursor-pointer">
                Submit
            </button>
            <div class="relative hidden" id="container-1">
                ...
                <div class="relative w-full">
                    ...
                    <label class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 w-full pl-10 :bg-gray-700 hidden"></label>
