        ...
        <div class="flex items-center justify-center p-12">
            ...
            <div class="mx-auto w-full max-w-[550px]">
                ...
                <div class="-mx-3 flex items-center justify-center">
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" readonly value="" required autofocus autocomplete="name" />
                            </div>
                        </div>
                    </div>
                    <div class="w-full px-3 sm:w-1/2">
                ...
                <div>
                    ...
                    <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" readonly value="" required autocomplete="username" />
