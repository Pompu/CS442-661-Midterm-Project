        ...
        <div class="max-w-2xl mx-auto ">
          <div class="p-4 max-w-md bg-white rounded-lg border shadow-md sm:p-8">
            <div class="flex justify-between items-center mb-4">
              <h3 class="text-xl font-bold leading-none text-gray-900 ">TO DO LIST</h3>
            </div>
            <div class="flow-root">
              <ul role="list" class="divide-y divide-gray-200"> 
                <div class="group bg-gray-900 p-4 transition-all duration-300 hover:rotate-1 lg:p-8">
                  ...
                  <div class="my-4">
                    <h3 class="text-2xl font-medium text-gray-200">Title</h3>
                  </div>
                  <div class="flex items-center gap-x-2">
                    <div>
                      <span class="text-xs text-gray-300">Find location</span>
                    </div>
                  </div>
