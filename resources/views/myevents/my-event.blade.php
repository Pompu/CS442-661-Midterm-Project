...
<div class="mt-10 mx-20 grid gap-x-10 gap-y-10 grid-cols-3">
    ...
    <a href="{{ route('myevents.create-event') }}" 
    class="max-h-full max-w-full mx-14 shadow-md border-black border flex justify-center items-center rounded-2xl hover:bg-gray-300 h-96">
