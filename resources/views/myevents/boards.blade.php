      ...
      <div class="grid grid-cols-3 ">
        ...
        <div class="overflow-auto max-h-[700px] max-w-md mx-5 p-4 bg-white rounded-lg border shadow-md sm:p-8 ">
          ...
          <div class="flex justify-between items-center mb-5 
            ...
            <a href="{{ route('myevents.create-postit', ['board'=> $board,'event' => $myevent['id'], 'myevent' => $myevent] )}}" class="font-medium text-blue-800 hover:bg-blue-800 hover:text-white transition-colors duration-300 rounded-full p-3">ADD</a>
          </div>
