...
<div class="container">
    ...
    <form action="{{ route('myevents.updateEvent',['organizer' => $organizer, 'myevent' => $myevent]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="create-container ">
                    <div class="max-h-full w-60 mx-14 shadow-md border-grey-300 border flex flex-col justify-center items-center rounded-2xl hover:bg-gray-300 h-96" id="imageContainer">
                        ...
                        <img id="imagePreview" class="w-full h-full object-cover rounded-2xl" src="{{ asset('storage/' . $myevent_details->image_path) }}">
                    </div>
                    @error('image')
                ...
                <div class="ml-20">
                            <div class="mb-4">
                                ...
                                id="eventname" name="eventname" type="text" placeholder="Event Name" value="{{ $myevent_details->name }}">
                            </div>
                            <div class="mb-4">
                                ...
                                id="eventdetail" name="eventdetail" type="text" placeholder="Event Detail" value="{{ $myevent_details->detail }}">
                            </div>        
                            <div class="mb-4">
                                ...
                                <input required class="shadow appearance-none border-gray-300 rounded w-80 py-2 px-3 text-gray-700 leading-tight focus:ring-violet-600" 
                                id="eventdate" name="eventdate" type="datetime-local" placeholder="Event Date" value="{{ $myevent_details->date }}">
                            </div>        
                            <div class="mb-4">
                                ...
                                <input required class="shadow appearance-none border-gray-300 rounded w-80 py-2 px-3 text-gray-700 leading-tight focus:ring-violet-600" 
                                id="eventbudget" name="eventbudget" type="number" placeholder="Event Budget" value="{{ $budget->cost }}">
                            </div>        
                        </div>
                        ...
                        <div class="ml-40">
                            <div class="mb-4">
                                ...
                                <input required class="shadow appearance-none border-gray-300 rounded w-80 py-2 px-3 text-gray-700 leading-tight focus:ring-violet-600" 
                                id="eventaddress" name="eventaddress" type="text" placeholder="Address" value="{{ $myevent_details->address }}">
                            </div>
                            <div class="mb-4">
                                ...
                                <option value="" disabled selected>Select Province</option>
                                    ...
                                    <option {{ $province->id == $myevent_details->province_id ? 'selected' : ''}} value="{{ $province->id }}">{{ $province->name }}</option>
                                    @endforeach
                                </select>
                            </div>   
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                id="addressdetail" name="addressdetail" type="text" placeholder="Address Detail" value="{{ $myevent_details->location_detail }}">
                            </div> 
    ...
    <form action="{{ route('myevents.deleteEvent', ['organizer' => $organizer, 'myevent' => $myevent]) }}" method="POST">
        @csrf
        @method('DELETE')
        
        <button type="submit" class="shadow-lg bg-red-500 hover:bg-red-400 appearance-none border rounded px-32 mx-2 text-gray-700 text-sm font-bold leading-tight cursor-pointer">
            Delete Event
        </button>
    </form> 
</div>
